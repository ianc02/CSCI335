...
public class DrawingForest90 extends RandomForest<Drawing,String,DrawingPoint, PixelUse> implements PixelUser {
    private int width, height;

    public DrawingForest90() {
        super(90, Drawing::allFeatures, Drawing::getFeatureValue, PixelUse::successor);
    }
