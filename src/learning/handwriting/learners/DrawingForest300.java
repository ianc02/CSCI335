...
public class DrawingForest300 extends RandomForest<Drawing,String,DrawingPoint, PixelUse> implements PixelUser {
    private int width, height;

    public DrawingForest300() {
        super(300, Drawing::allFeatures, Drawing::getFeatureValue, PixelUse::successor);
    }
